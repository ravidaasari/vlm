...
var xhr = new XMLHttpRequest();
    xhr.open('GET', `/decommission/find_vms.json?provider_id=${providerHandle.value}&source_vm=${vmHandle.value}`, true);
...
var xhr = new XMLHttpRequest();
    xhr.open('GET', `/decommission/find_vms_of_folder.json?provider_id=${providerHandle.value}&folders=${folderHandle.value}`, true);
...
providerHandle.addEventListener('change', function(){
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', `/decommission/find_datacenters.json?provider_id=${providerHandle.value}`, true);
...
vmHandle.addEventListener('change',function(){
  ...
  var xhr = new XMLHttpRequest();
  xhr.open('GET', `/decommission/find_folders.json?provider_id=${providerHandle.value}&source_dc=${sourceDcHandle.value}`, true);
